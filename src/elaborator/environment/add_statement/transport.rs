...
pub(super) struct TransportBuilder<'a> {
    env: &'a Environment,
...
impl<'a> TransportBuilder<'a> {
    ...
    pub(super) fn requirements(
        ...
        self.build_requirements(source_type, target_type, source, 0)
    }
    ...
    fn apply_datatype_attr(
        ...
        let attr_bindings = self.env.bindings.get_bindings(module_id, self.project);
        ...
        self.env.bindings.apply_potential(
            PotentialValue::Resolved(attr),
            vec![receiver],
            None,
            source,
        )
    ...
    fn build_requirements(
            ...
            (source_type, target_type)
        {
            ...
            {
                requirements.extend(self.build_requirements(
                    source_arg_type,
                    target_arg_type,
                    source,
                    depth + 1,
