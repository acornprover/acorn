...
pub struct Block {
    ...
    /// Blocks created internally by the elaborator will have None.
...
pub enum BlockParams<'a> {
    ...
    /// The values are constraints that need to be proved, generated by the type
    /// system rather than written explicitly in the source.
